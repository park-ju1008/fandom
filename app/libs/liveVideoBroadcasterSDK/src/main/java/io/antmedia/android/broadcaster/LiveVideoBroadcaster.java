...
public class LiveVideoBroadcaster extends Service implements ILiveVideoBroadcaster, CameraHandler.ICameraViewer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public final static int SAMPLE_AUDIO_RATE_IN_HZ = 32000;//44100;
                ...
                try {
                    ...
                    if (sCameraProxy.isCameraAvailable()) {
                        ...
                        if (parameters != null) {
                            ...
                            {
                                boolean encoderWorks = VideoEncoderCore.doesEncoderWork(previewSize.width, previewSize.height, 64000/*200000*/, 20);
